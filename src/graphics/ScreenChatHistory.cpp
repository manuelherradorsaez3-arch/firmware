...
void ScreenChatHistory::renderPicker()
{
    ...
    DisplayIface::drawText(0, 0, picker_.mode == Mode::ByNode ? "Chat history: Nodes" : "Chat history: Channels", true);
...
void ScreenChatHistory::handlePickerUp()
{
    picker_.cursor--;
}
void ScreenChatHistory::handlePickerDown()
{
    picker_.cursor++;
}
...
void ScreenChatHistory::handleDetailUp()
{
    detail_.cursor--;
}
void ScreenChatHistory::handleDetailDown()
{
    detail_.cursor++;
}
